...
<body>
    ...
    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1 firstcard">
        <h1 class="title bold">Student Info</h1></div>
    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-10 col-xs-offset-1 card">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="thumbnail year"><a href="#"><h1 class="year">Year 59</h1></a></div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="thumbnail year"><a href="#"><h1 class="year">Year 58</h1></a></div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="thumbnail year"><a href="#"><h1 class="year">Year 57</h1></a></div>
            </div>
        </div>
    </div>
