...
<div id="createvoucher" class="modal fade" role="dialog">
  <div class="modal-dialog text-left">
    ...
    <div class="row hidden-xs">
        <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 card">
            <div class="row">

<?php
    $get=mysqli_query($voucher,"SELECT * FROM voucher");
...
?>
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="thumbnail"><img src="<?php echo $row['img'];   ?>">
                        <div class="caption text-center">
                            <h4 class="grid text-center"><?php echo $row['description'] ?>  </h4>
                            ...
                            <div class="row">
                            <?php
                            echo '<div class="col-lg-12"><a class="btn btn-primary bold " role="button" href="Details.php?subject='.$row['id'].'&num='.$num_rows.'">More Details</a></div>';
                            ?>
                            </div>
                        </div>
                    </div>
